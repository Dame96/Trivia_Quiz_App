...
function GetQuestion() {
    ...
    return (
        <>
            ...
            <p>Here you can test your genius on a few popular topics! Follow the instructions and have fun testing your knowledge!</p>
            <p><strong>Instructions:</strong></p>
            <ol className="instructions">
                <li>Enter your name.</li>
                <li>Select a category for the question.</li>
                <li>Select a difficulty level for the question.</li>
                <li>Click the "Fetch Question" button to get your question!</li>
            </ol>
            <div>
